...
exports.default = {
    ...
    GET: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var userId, findMessages, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    userId = req.body.userId;
                    return [4 /*yield*/, model_1.default.findMessages(userId)];
                case 1:
                    findMessages = _a.sent();
    ...
    POST: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, message, id, userId, file, filename, createMessage, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    _a = req.body, message = _a.message, id = _a.id, userId = _a.userId;
                    file = req.files;
                    if (!message || !file || !id)
                        return [2 /*return*/, res.status(400).json({ message: "BAD_REQUEST!" })];
                    filename = file_1.default.fileUpload(file.file);
                    return [4 /*yield*/, model_1.default.createMessage(message, filename, id, userId)];
                case 1:
                    createMessage = _b.sent();
                    if (!createMessage) {
                        file_1.default.fileDelete(filename);
                        return [2 /*return*/, res.status(500).json({ message: "SERVER_CREATED_ERROR!" })];
                    }
                    res.status(200).json({ message: "CREATED", data: createMessage });
                    event_1.default.emit("CREATED_MESSAGE", createMessage);
                    return [3 /*break*/, 3];
                case 2:
                    error_2 = _b.sent();
                    res.status(500).json({ message: "SERVER_ERROR!" });
    ...
    DELETE: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var userId, messageId, deleteMessage, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    ...
                    return [4 /*yield*/, model_1.default.deleteMessage(messageId, userId)];
                case 1:
                    ...
                    event_1.default.emit("DELETED_MESSAGE", deleteMessage);
                    file_1.default.fileDelete(deleteMessage.file);
                    return [3 /*break*/, 3];
                case 2:
                    error_3 = _a.sent();
                    res.status(500).json({ message: "SERVER_ERROR!" });
